...
import { Decimal, Loader, Pagination } from '../../openware';
    ...
    private renderTableRow = (type, item) => {
        ...
        switch (type) {
            case 'deposits': {
                ...
                const state = this.props.intl.formatMessage({ id: `page.body.history.deposit.content.status.${item.state && item.state.toLowerCase()}` });
...
// WEBPACK FOOTER //
// src/drone/src/src/containers/HistoryElement/index.tsx
